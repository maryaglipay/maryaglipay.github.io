...
There has been, for example, a well-designed cluster randomized trial (see @abaluck2021) in Bangladesh that found that a mask intervention that sought to provide and educate villages about masks saw a 9% reduced seroprevalence of infection compared to villages without the intervention. However, this was done in adults, in an entirely different context.
